...
const FeaturedCard = () => {
  return (
    <div className={styles.cardsBody}>
        <div className={`${styles.card} sticky top-[99vw] lg:top-[25vw] xl:top-[17vw] 2xl:top-[12vw]`} >
        ...
        <div className={`${styles.card} sticky top-[110vw] lg:top-[31vw] xl:top-[22vw] 2xl:top-[16vw]`} >
        ...
        <div className={`${styles.card} sticky top-[130vw] lg:top-[34vw] xl:top-[26vw] 2xl:top-[20vw]`} >
