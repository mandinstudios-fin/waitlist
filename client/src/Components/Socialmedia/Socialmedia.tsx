  ...
  return (
    <ul className="example-2">
      <li className="icon-content">
        <a
          onClick={handleClick} href="https://www.spotify.com/"
          aria-label="Spotify"
          data-social="spotify"
        >
      ...
      <li className="icon-content">
        <a
          onClick={handleClick} href="https://www.pinterest.com/"
      ...
      <li className="icon-content">
        <a
          onClick={handleClick} href="https://dribbble.com/"
          aria-label="Dribbble"
      ...
      <li className="icon-content">
        <a
          onClick={handleClick} href="https://telegram.org/"
          aria-label="Telegram"
